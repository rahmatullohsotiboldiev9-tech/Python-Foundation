...
print("===== string =====")
# methods: title(), upper(), lower(), capitalize(), replace(), find().
...
result = course.replace("FullStack", "Masteclass")
print(f"the result (4): {result}")


print("===== boolean =====")
# function > typee () input() bool() int() str() float() list() dict() set() tuple()
